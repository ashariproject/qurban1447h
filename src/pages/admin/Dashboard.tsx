    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-gradient-to-br from-red-500 to-red-600 text-white p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
            <h3 className="font-semibold text-lg mb-2">Distribusi</h3>
            <p className="text-red-100 text-sm">Kelola distribusi ke penerima</p>
            <div className="mt-3">
              <a href="/distribution/recipients" className="text-white underline hover:text-red-200">Akses Menu →</a>
            </div>
          </div>
        </div>
