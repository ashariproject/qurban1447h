...
import { Printer, Calendar, ShieldCheck, Heart, Info } from 'lucide-react';
    ...
    <>
      ...
      <style>{`
        @media print {
          ...
          /* Hide print button, close button, dialog overlays */
          .print-hide {
          ...
          <div id="printable-modal-content" className="p-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-50 p-4 rounded-xl border border-slate-100">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button onClick={handlePrint} size="sm" className="bg-blue-600 hover:bg-blue-700 text-white gap-1.5 font-bold print-hide">
                ...
                {shohibuls.length === 0 ? (
                  ...
                  <div className="divide-y divide-slate-200">
                    {shohibuls.map((s, index) => (
                      <div key={s.id} className="px-4 py-2.5 text-xs flex justify-between items-center hover:bg-slate-100 transition-colors">
